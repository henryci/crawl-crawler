import { TrendingUp, Search, Filter, Trophy, User, ArrowUpDown } from "lucide-react";
  ...
  return (
    <PageWrapper>
      ...
      <PageHeader
        ...
        subtitle="Search and explore player win streaks"
        icon={TrendingUp}
        variant="gold"
      />
      ...
      <AlertBanner
        title="Coming Soon"
        message="Live streak data integration is under development. Below is a preview with sample data showing the intended functionality."
        variant="gold"
      />
