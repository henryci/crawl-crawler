import { FileText, LinkIcon, AlertCircle, User, Map, Swords, Clock } from "lucide-react"
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Morgue Viewer</h1>
              <p className="text-sm text-muted-foreground">Parse and visualize DCSS morgue files</p>
            </div>
          </div>
        </div>
        ...
        <Card className="mb-8 bg-card border-border">
          ...
          <CardContent>
            ...
            {/* Coming Soon Notice */}
            <div className="mt-4 flex items-start gap-2 p-3 rounded-md bg-mana/10 border border-mana/20">
              <AlertCircle className="w-4 h-4 text-mana mt-0.5 shrink-0" />
              <div className="text-sm">
                <p className="font-medium text-mana">Coming Soon</p>
                <p className="text-muted-foreground">
                  Morgue parsing functionality is under development. Below is a preview of how parsed data will be
                  displayed.
                </p>
              </div>
            </div>
