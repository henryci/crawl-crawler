import { Trophy, Search, Filter, Medal, Crown, Zap, Skull, Clock, ArrowUpDown, AlertCircle } from "lucide-react"
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-md bg-mana/10 border border-mana/30 flex items-center justify-center">
              <Trophy className="w-5 h-5 text-mana" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-foreground">Records Explorer</h1>
              <p className="text-sm text-muted-foreground">Discover game records and achievements</p>
            </div>
          </div>
        </div>

        {/* Coming Soon Notice */}
        <div className="mb-6 flex items-start gap-2 p-4 rounded-md bg-mana/10 border border-mana/20">
          <AlertCircle className="w-5 h-5 text-mana mt-0.5 shrink-0" />
          <div className="text-sm">
            <p className="font-medium text-mana">Coming Soon</p>
            <p className="text-muted-foreground">
              Live records integration is under development. Below is a preview with sample data showing the intended
              functionality.
            </p>
          </div>
        </div>
